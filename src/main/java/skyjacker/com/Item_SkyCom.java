...
public class Item_SkyCom {

   static ArrayList<String> xpathStringsList = SkyCom_data_processing_utils.xpathStringsListInit();
    ...
    String breadCrumbs;
    String shortDesc;
    String sku; String title;
    String itemParamsShortTable; String itemParamsShortTableHTML;
    String itemFitmentTable; String itemFitmentTableHTML;

    String longDesc;
    String fitment;
    String productNotes;
    String pdfLink;     String imgLink;
    String liftString;


    public Item_SkyCom(File file, String domain) {
        this.inputFile = file;
    ...
    public void fieldsInit() {
         urlString="https://skyjacker.com/"+inputFile.getName();
         ...
         itemParamsShortTable =generateCellContent(xpathStringsList.get(4), doc);
         itemParamsShortTableHTML =generateCellContentHTML(xpathStringsList.get(4), doc);
        ...
        itemFitmentTableHTML =generateCellContentHTML(xpathStringsList.get(5), doc);
         ...
         pdfLink =generateCellContent(xpathStringsList.get(7), doc);
         imgLink =generateCellContentForPicUrl(xpathStringsList.get(8), doc,", ");
         liftString =generateCellContent(xpathStringsList.get(9), doc);
    ...
    public static String generateCellContent(String xpath, Document doc) {
        ...
        //csv
        { sb./*append("\"").*/append(data_processing_utils.generateWebElementValue(element,xpath))/*.append("\"")*/.append(SkyCom_data_processing_utils.lineSeparator); }
