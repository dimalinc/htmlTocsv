...
public class Scenario_PRESTA {

    public static void main(Item item, String brandForXls,
        ...
        if (item.carObjectsList!=null)
            for (Car car : item.carObjectsList) {
               ...
               /* System.out.println("itemTitleString = "+car.itemTitleString);
                ...
                listingStringsArrayList.add( (car.carItemSku/*.replace("\\r\\n","")*/+" "+item.itemShortDescription).replace("[]","") );
        ...
        if (item.carObjectsList==null) {
            ...
            arrayListOfAllStringsForCSV_PRESTA.add(listingStringsArrayListNoCars.toArray(new String[listingStringsArrayListNoCars.size()]));
        ...
        for (String[] stringArray:arrayListOfAllStringsForCSV_PRESTA) {
