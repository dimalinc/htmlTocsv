...
public class writeToXls_Base_Scenario_ItemList {
    ...
    static ArrayList<Item> generatedItemObjectsArrayList = new ArrayList<>();
    ...
    public static void main(String inputBrand, String inputBrandForXls,String inputDir, String inputWriteAllCSV_fileName, String inputDomain,int inputFilesNumberStart, int inputFilesNumberFinish) {
        ...
        System.out.println(filesArrayList.size()+" files "+filesArrayList);
        ...
        /*int*/ n = 1;
        for (Item item: generatedItemObjectsArrayList) {
        ...
        for (Item item : generatedItemObjectsArrayList) {
         //   if ( (inputFilesNumberStart!=0) && (n<inputFilesNumberStart) ) { n++; continue; }
          ...
          //  if ( (inputFilesNumberFinish!=0) && (n>inputFilesNumberFinish) ) break;
            ...
            // write to EXCEL
        try {
            writeExcel(arrayListOfAllStringsForCSV, brand);
            writeExcel(arrayListOfAllStringsForCSV_noCars, brand+"_noCars");
        } catch (IOException e) {
            e.printStackTrace();
        }
        // write to CSV
