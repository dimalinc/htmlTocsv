...
public class bak implements Runnable{
    ...
    static String brand = "BAK"+"_1row";
    static String brandForXls = "BAK";
    static String dir="D:\\savedHtml\\savedHtml_bak" + "\\";
    ...
    public void run() {
        writeToXls_PRESTA_CsvAtts_Scenario_bak.main(brand,brandForXls,dir,writeAllCSV_fileName,domain,filesNumberStart,filesNumberFinish);
    }
}
