...
public class Daystar_key implements Runnable{
    ...
    public void run() {
        writeToXls_PRESTA_CsvAtts_Scenario_Daystar_key.main(brandForFilename,brandForXls,dir,writeAllCSV_fileName,domain,filesNumberStart,filesNumberFinish);
    }
}
