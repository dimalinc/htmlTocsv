...
public class Fabtech_kits implements Runnable{
    static int filesNumberStart=0, filesNumberFinish=0;
    static String brandForFilename = "Fabtech_kits"+"_1row";
    static String brandForXls = "Fabtech";
    static String dir="D:\\savedHtml\\savedHtml_fabtech_kits_KEYSTONE" + "\\";
    ...
    public void run() {
        writeToXls_PRESTA_CsvAtts_Scenario_Fabtech_kits.main(brandForFilename,brandForXls,dir,writeAllCSV_fileName,domain,filesNumberStart,filesNumberFinish);
    }
}
