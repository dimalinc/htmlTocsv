...
public class GenY_key implements Runnable {
    //   static int filesNumberStart=412, filesNumberFinish=418;
     static int filesNumberStart=0, filesNumberFinish=0;
    static String brandForFilename = "Gen-Y"+"_1row";
    static String brandForXls = "Gen-Y";
    static String dir="D:\\savedHtml\\savedHtml_Gen-Y_key" + "\\";
    ...
    public void run() {
        writeToXls_PRESTA_CsvAtts_Scenario_GenY_key.main(brandForFilename,brandForXls,dir,writeAllCSV_fileName,domain,filesNumberStart,filesNumberFinish);
    }
}
