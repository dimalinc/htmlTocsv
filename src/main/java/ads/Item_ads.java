...
public class Item_ads {
    ...
    static ArrayList<String> xpathStringsList = Data_processing_utils_ads.xpathStringsListInit();

    static ArrayList<Element> jsoupElementsList = new ArrayList<>();

final static String domain ="https://www.adsshocks.com/";
    ...
    public Item_ads(File file, String domain) {
        this.inputFile = file;
        try {
    ...
    public static String generateCellContent(String xpath, Document doc) {
        ...
        //csv
        {
            sb./*append("\"").*/append(data_processing_utils.generateWebElementValue(element, xpath))/*.append("\"")*/.append(Data_processing_utils_ads.lineSeparator);
        }
